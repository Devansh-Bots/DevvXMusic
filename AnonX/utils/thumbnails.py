...
async def gen_thumb(videoid, user_id):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "DEVU X MUSIC", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "DEV PLAYER", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
...
async def gen_qthumb(videoid, user_id):
    try:
        ...
        if 1==1:
            ...
            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "ATHENA X MUSIC", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "ATHENA PLAYER", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
